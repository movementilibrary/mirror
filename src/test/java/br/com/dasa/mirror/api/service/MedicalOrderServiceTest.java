...
//       // examsMedicalOrders = new Exams("","CODADMISSION","","26.00", "2019-11-26T16:57:42.396Z",  "Gel", "ADMISSION GEL", Status.PENDENTE,"312321");
//        listExams.add(examsMedicalOrders);
//
//      //  medicalOrders = new MedicalOrders("1f2fb6df-539f-4c74-a615-a199d96c841c","123",listExams);
//        listMedicalOrders.add(medicalOrders);
//    }
//
//    @Test
//    public void deveVerificarSeDeParaUnidadeFoiRealizado() {
//        List<MedicalOrders> responseMedicalOrders = medicalOrderService.atualizaListaDeExamesMedicalOrders(admmissao, listMedicalOrders);
