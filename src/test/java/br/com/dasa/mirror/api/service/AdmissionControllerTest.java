...
public class AdmissionControllerTest {
    ...
    public void criaAdmissao(){
        ...
        exams = new Exams("", "CODEMIRROR", "Gel","MIRROR GEL", "PENDENTE",  "312321", "2019-11-26T16:57:42.396Z", "13.00",  listAdditionalProperties);
        listExams.add(exams);
        ...
        medicalOrders = new MedicalOrders("", "CRM",  "123", "", listExams);
